...
export default function SlideTextButton({
  ...
  return (
    ...
    >
      <Link
        className={cn(
          "group relative inline-flex h-10 items-center justify-center overflow-hidden rounded-lg px-8 py-5.5 font-medium text-base tracking-tighter transition-all duration-300 md:min-w-48",
          variantStyles,
          className
        )}
        href={href}
