...
export function ThemeToggle() {
  ...
  if (!mounted) {
    return (
      <Button variant="ghost" size="icon" className="size-9 hover:bg-foreground/5!">
  ...
  return (
    <Button variant="ghost" size="icon" onClick={() => setTheme(theme === "dark" ? "light" : "dark")} className="hover:bg-foreground/5!">
      {theme === "dark" ? 
